    ...
    public function my_plugin_function(){
        ...
        <div class="field_wrap">
            <ul class="ui-sortable hide <?php if( $tableArray ){echo 'border'; } ?>">
                ...
                if( $result ){
                    foreach ($result as $key => $value) {
                        ?> <li class="ui-state-default ui-sortable-handle" data-value="<?php echo $key; ?>"><?php echo $value; ?><span id="add">+</span></li> <?php
                    }
                }
                ?>
            ...
            foreach ($fields as $key => $value) {
                ?> <li class="ui-state-default ui-sortable-handle" data-value="<?php echo $key; ?>"><?php echo $value; ?><span id="delete">X</span></li> <?php
            }
            ?>
            </ul>
        ...
        <div class="change_post_type">
            ...
            $posts = wp_count_posts($post_type);
                ...
                <form>
                    ...
                    <input id="btn-posttype" type="submit" class="button" value="<?php _e('Change post type', 'cm_translate'); ?>">
                    <?php
                    if( $posts->publish !== 0 ){
                        ?>
