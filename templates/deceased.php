<div class="cm-entry-content">
    <article>
        ...
        <div class="deceased-info">
            <h2 class="deceased-name"><a href="<?php the_permalink(); ?>"
                                         title="<?php the_title_attribute(); ?>"><?php echo ( isset( $post_meta['honoraryitle'] ) && ! empty( $post_meta['honoraryitle'][0] ) ? $post_meta['honoraryitle'][0] . ' ' : '' ) . esc_html( $post_meta['name'][0] ) . ' ' . esc_html( $post_meta['familyname'][0] ); ?></a>
            </h2>
				...
				if ( is_array( $post_meta['flowers'] ) && isset( $post_meta['flowers'][0] ) ) {
					...
					if ( $string != '0' ) {
                        ...
                        <input type="button"
                               ...
                               value="<?php echo esc_attr__( 'Flowers', 'cm_translate' ); ?>" <?php echo ( $can_order_flower ) ? '' : 'disabled'; ?>>
						<?php
					}
				}
