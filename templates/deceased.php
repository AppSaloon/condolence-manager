        ...
        <div class="deceased-info">
                ...
                <div class="deceased-partner">
                    <p>
                        <?php foreach ($relations as $relation): ?>
                            ...
                            } else if ($relation['type'] == 'Other') {
                                $relation_type = $relation['other'];
                            }
                            ?>
                            <?php if ($relation_type !== false): ?>
                                <span class="deceased-info-header"><?php echo $relation_type ?></span>
            ...
            <?php if (isset($post_meta["birthdate"][0]) && $post_meta["birthdate"][0] != '') : ?>
                ...
                <div class="deceased-born-place-and-date">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Born', 'cm_translate') . ' ' . esc_html__('in', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
            ...
            <?php if (isset($post_meta["dateofdeath"][0]) && $post_meta["dateofdeath"][0] != '') : ?>
                ...
                <div class="deceased-death-place-and-date">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Passed away', 'cm_translate') . ' ' . esc_html__('in', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
            ...
            if ( $show_funeraldate && isset($post_meta["funeraldate"][0]) && $post_meta["funeraldate"][0] != ''): ?>
                ...
                <div class="deceased-funeral-date">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Funeral date', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
                ...
                <?php if ($location_id != 0) : ?>
                    ...
                    <?php if (!empty($location)) : ?>
                        <div class="deceased-linked-location-header">
                            <p>
                                <span class="deceased-info-header"><?php echo esc_html__("Laid out at", "cm_translate"); ?></span>
                                <span class="deceased-info-body">
            ...
            <?php if ($post_meta["funeralinformation"][0]) : ?>
                <div class="deceased-funeral-info">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Funeral information', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
            ...
            <?php if ($post_meta["prayervigilinformation"][0]) : ?>
                <div class="deceased-wake">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Prayer vigil information', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
            ...
            <?php if ($post_meta["greetinginformation"][0]) : ?>
                <div class="deceased-greetings">
                    <p>
                        <span class="deceased-info-header"><?php echo esc_html__('Greeting information', 'cm_translate'); ?></span>
                        <span class="deceased-info-body">
